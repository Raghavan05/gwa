...
// import maledoc1 from './assests/img/maledoc1.png'
...
const MiddlePart = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const elementTwo = document.querySelectorAll('.reveal-2');
  ...
  return (
    <div className='main-section'>
      ...
      <div className='container'>
        <div className="row m-md-5 m-2 d-flex flex-column-reverse flex-md-row">
        ...
        <div className="row">
          <div className="col-12 col-md-6 d-flex flex-row justify-content-center align-items-center">
